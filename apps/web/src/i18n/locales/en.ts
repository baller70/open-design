...
export const en: Dict = {
  ...
  'settings.onboardingCloudTitle': 'Connect your own AI',
  'settings.onboardingCloudBody': 'Use Claude Code, Codex, Gemini, MiniMax, or your own API key. Open Design Cloud is optional.',
  'settings.onboardingCloudSignIn': 'Use local coding agent',
  ...
  'settings.onboardingCloudRights': 'Self-hosted runtime',
